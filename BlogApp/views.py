...
#send_mail('Hello', 'Very imp msg....','chandanajan04@gmail.com',['jamalesh.p@gmail.com','kamalbasha9581@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'chandanajan04@gmail.com', [cd['to']])
            sent=True;
    else:
	    form=EmailSendForm()
